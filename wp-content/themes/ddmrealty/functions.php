...
function remove_menus () {
	...
	$restricted = array(__('Dashboard'), __('Media'), __('Links'), __('Appearance'), __('Tools'), __('Settings'), __('Plugins'), __('Users'), __('Comments'), __('Posts'), __('Pages'));
	end ($menu);
	while (prev($menu)){
