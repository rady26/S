        ...
        <div id="sectionContent">   
			...
			<?php if(isset($confirmation) && $confirmation == "confirm") { ?>
                            ...
                            <div class="form">
                                <table class="formInput" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="tdRight"><p class="confirm"><?php echo $your_name; ?></p></td>
                                    </tr>                                    
                                    <tr>
                                        <td class="tdLeft"><p class="desc">TELEPHONE<font>*</font></p></td>
                                        <td class="tdRight"><p class="confirm"><?php echo $telephone; ?></p></td>
                                    </tr>
                                    <tr>
                                        <td class="tdLeft"><p class="desc">ADDRESS</p></td>
                                        <td class="tdRight"><p class="confirm"><?php echo $address; ?></p></td>
                                    </tr>
                                    <tr>
                                        <td class="tdLeft"><p class="desc">E-MAIL<font>*</font></p></td>
                                        <td class="tdRight"><p class="confirm"><?php echo $email; ?></p></td>
                                    </tr>
                                    <tr>
                                        <td class="tdLeft"><p class="desc">MESSAGE<font>*</font></p></td>
                                        <td class="tdRight"><p class="confirm"><?php echo $content; ?></p></td>
                                    </tr>
                                </table>
                                <div class="control">
                                    <form action="<?php the_permalink(); ?>" method="post">
                                        ...
                                        <input type="submit" name="submitconfirm" class="submit linkimg" value="" />
                                    </form>
                                    <form action="<?php the_permalink(); ?>" method="post">
                                        <input type="hidden" value="<?php echo $your_name; ?>" name="your_name" />
                                        <input type="hidden" value="<?php echo $telephone; ?>" name="telephone" />
                                        ...
                                        <input type="hidden" value="<?php echo $email; ?>" name="email" />
                                        <input type="hidden" value="<?php echo $content; ?>" name="content" />
                                        <input type="submit" name="btnreset" class="return linkimg" value="" />
                                    </form>
                                </div>
                            </div>
                            <div class="info">
            ...
            If there is no connection,please contact us from mail form again.</p>
                            <div id="backTop">
                                <a href="index.html"><img src="<?php echo get_template_directory_uri(); ?>/img/thanks/back_top.jpg" class="linkimg" /></a>
                            </div>	
                        </div>
						...
						<div class="form">						
							<form action="<?php the_permalink(); ?>" id="contactForm" method="post">
									...
									<tr>
										...
										<td class="tdRight">
											<label>
                                                ...
                                                <!--<span style="color:#999;font-size:9px;">(Example: 000-000-000)</span>-->
												<?php 
													if($telephoneError != '') {
								...
								<div class="control">
                                    ...
                                    <input type="submit" name="submitcontact" class="submit linkimg" value="" />
                                    <input type="reset" name="reset" class="reset linkimg" value="" />
		...
		Phnom Penh.<p>
							...
							<div class="contact">
								...
								<table class="contact" cellpadding="0" cellspacing="0">
									...
									<tr><td>Fax        </td><td>:  (855) 23 995 528</td></tr>
									<tr><td>Website </td><td>:​  <font>www.ddmrealty.com.kh</font></td></tr>
									<tr><td>E-mail    </td><td>:  <img style="vertical-align: middle;" src="<?php echo get_template_directory_uri(); ?>/img/email-orange.png" alt="Email" title="Email" /></td></tr>
								</table>
								<p>
							</div>
						</div>
